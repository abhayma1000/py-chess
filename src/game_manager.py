import numpy as np
from src import graphics_manager
...
class GameManager():
    def __init__(self):
        ...
        self.graphics_manager.window.mainloop()
    ...
    def initialize_board(self):
        ...
        self.graphics_manager = graphics_manager.GraphicsManager(self.board)

    def move_piece_to_square(self, square: tuple, new_square: tuple):
        self.board[new_square[0]][new_square[1]] = self.board[square[0]][square[1]]

        self.board[new_square[0]][new_square[1]].square = square
